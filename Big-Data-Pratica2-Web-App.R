# Big Data na Prática 2 - Analytics Web App Para Grandes Volumes de Dados: Como o PIB e a Desigualdade Social Influenciam no Crescimento da Netflix?

#setwd("C:/BigDataRAzure/Cap04-Graficos")
#getwd()
...
# Nota: Usuários Windows devem remover este trecho da linha abaixo (incluindo a vírgula): theme = shinytheme("cerulean"),
...
server <- function(input, output) {
  ...
  output$mapPlot <- renderPlotly({
    ...
    l <- list(color = toRGB("olivedrab"), width = 0.5)
